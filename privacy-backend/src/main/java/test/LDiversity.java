...
public class LDiversity {
    ...
    public static void main(String args[]) throws Exception {
        int datasetSize = getDatasetSize(datasetID);

        List<String> QIsCombinations = createQIsCombinations(QIs, "\t");
        Map<Integer, List<String>> numberOfQIsQIsCombinations = getNumberOfQIsQIsCombinations(QIsCombinations, "\t");
        ...
        for (String sensitiveAttribute : sensitiveAttributes) {
            ...
            for (int i = 1; i <= numberOfQIsQIsCombinations.size(); i++) {
                for (String combination : numberOfQIsQIsCombinations.get(i)) {
                    ...
                    while (!stack.isEmpty()) {
                        String valuesOf[] = getValuesOf(datasetID, fields, stack.get(0));

                        Map<String, String> entryIDSensitiveAttribute = getEntryIDSensitiveAttribute(datasetID, valuesOf, fields, sensitiveAttribute);
    ...
    private static int getDatasetSize(String datasetID) throws Exception {
        int datasetSize = 0;
    ...
    private static String[] getValuesOf(String datasetID, String fields[], String entryID) throws Exception {
    ...
    private static Map<String, String> getEntryIDSensitiveAttribute(String datasetID, String valuesOf[], String fields[], String sensitiveAttribute) throws Exception {
